...
3. 使用 %s 格式化输出保存的数据
'''
print(f'name = {input("请输入name：")}', f'age = {input("请输入age：")}', f'love = {input("请输入love：")}', sep='\n')
...
1. 通过使用find函数的方式替换掉index
'''
print("asdapythonasdasds".find("python"))
...
'''
words = " great craTes Create great craters, But great craters Create great craters "
print(words.strip().lower().replace('great', 'greats').title() if "great" in words else "great不在该字符串中")
